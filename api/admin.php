        ...
        <div class="admin-container">
            <div class="admin-header">
                <div>
                    ...
                    <p>Bienvenue, <strong><?php echo htmlspecialchars($_SESSION['username']); ?></strong>. Panel
                        connecté à Néon DB.</p>
                </div>
                <a href="/api/auth.php?action=logout" class="btn-logout-nav"
                    style="background:#ef4444; color:white; padding: 0.75rem 1.5rem; border-radius:12px; text-decoration:none; font-weight:bold;">Déconnexion</a>
            </div>
                ...
                <div class="admin-card">
                    ...
                    <form class="admin-form" id="veilleForm">
                        <div class="admin-input-group">
                            ...
                            <input type="text" id="v_title" class="admin-input" placeholder="Faille zero-day..."
                                required>
                        </div>
                        <div class="admin-input-group">
                        ...
                        <div class="admin-input-group">
                            <label>Source</label>
                            <input type="text" id="v_source" class="admin-input" placeholder="ANSSI, CERT-FR..."
                                required>
                        </div>
                ...
                <div class="admin-card">
                    ...
                    <form class="admin-form" id="formationForm">
                        ...
                        <div class="admin-input-group">
                            ...
                            <input type="text" id="f_pdf" class="admin-input" placeholder="/public/uploads/..."
                                required>
                        </div>
                ...
                <div class="admin-card">
                    ...
                    <form class="admin-form" id="certForm">
                        ...
                        <div class="admin-input-group">
                            ...
                            <input type="text" id="c_file" class="admin-input" placeholder="/public/uploads/..."
                                required>
                        </div>
