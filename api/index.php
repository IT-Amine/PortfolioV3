        ...
        <div class="hero-container">
            ...
            <div class="hero-cta" data-aos="fade-up" data-aos-delay="200">
                ...
                <?php if (isset($_SESSION['role'])): ?>
                    <a href="api/view.php?file=CV" class="btn-secondary" target="_blank">📄 Mon CV (Sécurisé)</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="veille-sources-info">
                ...
                <div class="sources-links">
                    ...
                    <a href="https://www.ssi.gouv.fr/" target="_blank" class="source-link">Cyber-sécurité
                        Gouvernementale</a>
                </div>
            </div>
    ...
    <?php if (isset($_SESSION['role'])): ?>
        <section id="formations" class="section">
            <div class="container">
                ...
                <h2 class="section-title" style="margin-top: 4rem;">Certifications <span class="gradient-text">Clés</span>
                </h2>
