export const projectsData = [
  {
    ...
    desc:
      "Migration vers un nouveau système de gestion des utilisateurs, avec planification et déploiement sans interruption de service.",
  ...
  },
  {
    title: 'Serveur RAID',
    desc:
      "Configuration d’un serveur RAID pour assurer la redondance et la sécurité des données.",
  ...
  },
  {
    ...
    desc:
      "Mise en place d’une stratégie de sauvegarde automatique des données critiques.",
  ...
  },
  {
    title: 'Portfolio',
    desc:
      'Conception et développement de ce portfolio 3D interactif en React (Vite + Tailwind), déployé sur Vercel.',
  ...
  // --- Projet global BTS SIO – AP1 (synthèse de tous les TP) ---
  {
    ...
    desc:
      "Projet complet couvrant la maquette réseau du site BTS SIO, le déploiement d’un serveur Web/FTP et d’un outil de tickets d’incidents, la mise en production sur NUTANIX et l’automatisation des sauvegardes vers un NAS avec transferts sécurisés (SFTP/FTPS).",
    tech: [
      'Cisco Packet Tracer',
      'VirtualBox',
      'Serveur Web / FTP',
